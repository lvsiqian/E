package com.lvsiqian.mvplibs.utils;

import android.content.Context;
import android.content.SharedPreferences;

import com.lvsiqian.mvplibs.manger.MvpManger;
...
public class MvpSpUtils {
    ...
    public static String getString(String spName,String key){
        return MvpManger.getContext().getSharedPreferences(spName,Context.MODE_PRIVATE).getString(key,null);
    }
    ...
    public static long getLong(String spName,String key){
        return MvpManger.getContext().getSharedPreferences(spName,Context.MODE_PRIVATE).getLong(key,0);
    }
    ...
    public static void remove(String spName,String key){
       SharedPreferences preferences =  MvpManger.getContext().getSharedPreferences(spName,Context.MODE_PRIVATE);
